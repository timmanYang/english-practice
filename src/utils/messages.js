...
export function getPerfectMsg() {
  return pick(success.perfect)
}

export function getGreatMsg() {
  return pick(success.great)
}

export function getGoodMsg() {
  return pick(success.good)
}

export function getFailureMsg() {
  return pick(failure)
}

export function getResultMsg(score, total) {
